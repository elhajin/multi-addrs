...
interface ISubAccountFactory {
    ...
    function getAccount(address user, uint256 accountNumber) external view returns (address);
    ...
    function getAccountsCount(address user) external view returns (uint256);
    ...
    function isAccountDeployed(address user, uint256 accountNumber) external view returns (bool);
}
