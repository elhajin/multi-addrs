...
contract SubAccountFuzzTest is Test {
    ...
    function testFuzz_nonMaster_cannotDrainETH(
        address master,
        address attacker,
        address recipient,
        uint256 amount
    ...
    function testFuzz_master_returnDataForwarded(
        address master,
    ...
    function testFuzz_master_revertPropagated(
        address master,
    ...
    function testFuzz_anyoneCanDeposit(
        address master,
        address depositor,
        uint256 amount
    ) public {
    ...
    function testFuzz_shortCalldata_returnsEmpty(
        address master,
        uint8 length
    ) public {
        vm.assume(master != address(0));
    ...
    function testFuzz_valueTransferAccuracy(
        address master,
        uint256 value,
        bytes calldata payload
    ) public {
    ...
    function testFuzz_mastersIsolated(
        address master1,
        address master2,
        uint256 amount
    ) public {
